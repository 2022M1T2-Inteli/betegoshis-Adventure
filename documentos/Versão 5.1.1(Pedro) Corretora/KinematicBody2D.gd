...
func add_investimentos():
	Global.investimentos += 10
...
func _process(_delta):
	$Label.text = str(Global.investimentos)
	$Camera2D/Dinheiro/DinheiroLabel.text = "BT$  " + str(Global.money)
...
func _on_PermissaoPraAndar_mouse_entered():
	pass # Replace with function body.
func _on_PermissaoPraAndar_mouse_exited():
	pass
