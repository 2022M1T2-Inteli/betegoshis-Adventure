...
func _process(_delta):
	...
	if Global.BarraFome == 10:
		$Camera2D/Dinheiro/Popups/aviso_fome.visible = true
		$Camera2D/Dinheiro/Popups/aviso_fome/atencao_fome/Animacao_fome.play("popup_fome")
		$Camera2D/Celular/AbrirCelular.visible = false
		$Camera2D/Controles/Controlesorg.visible = false
		
	if Global.BarraFelicidade == 10:
		$Camera2D/Dinheiro/Popups/aviso_felicidade.visible = true
		$Camera2D/Dinheiro/Popups/aviso_felicidade/atencao_felicidade/Animacao_felicidade.play("popup_felicidade")
		$Camera2D/Celular/AbrirCelular.visible = false
		$Camera2D/Controles/Controlesorg.visible = false
		
	if Global.BarraEnergia == 10:
		$Camera2D/Dinheiro/Popups/aviso_energia.visible = true
		$Camera2D/Dinheiro/Popups/aviso_energia/atencao_energia/Animacao_energia.play("popup_energia")
		$Camera2D/Celular/AbrirCelular.visible = false
		$Camera2D/Controles/Controlesorg.visible = false
		
func _on_botao_sair_fome_pressed():
	$Camera2D/Dinheiro/Popups/aviso_fome/atencao_fome/Animacao_fome.play_backwards("popup_fome")
	$Camera2D/Celular/AbrirCelular.visible = true
	$Camera2D/Controles/Controlesorg.visible = true

func _on_botao_sair_felicidade_pressed():
	$Camera2D/Dinheiro/Popups/aviso_felicidade/atencao_felicidade/Animacao_felicidade.play_backwards("popup_felicidade")
	$Camera2D/Celular/AbrirCelular.visible = true
	$Camera2D/Controles/Controlesorg.visible = true

func _on_botao_sair_energia_pressed():
	$Camera2D/Dinheiro/Popups/aviso_energia/atencao_energia/Animacao_energia.play_backwards("popup_energia")
	$Camera2D/Celular/AbrirCelular.visible = true
	$Camera2D/Controles/Controlesorg.visible = true
