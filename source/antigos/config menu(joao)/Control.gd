...
func _on_TextureButton_pressed():
	if sound:
		sound = false
		$TextureButton.texture_normal = soundoff_buttons
	else:
		sound = true
		$TextureButton.texture_normal = soundon_buttons

func _on_TextureButton2_pressed():
	if music:
		music = false
		$TextureButton2.texture_normal = musicoff_buttons
	else:
		music = true
		$TextureButton2.texture_normal = musicon_buttons
